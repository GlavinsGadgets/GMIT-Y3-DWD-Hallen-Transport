...
<body class="bg-light">
    ...
    <div class="nav-scroller bg-white box-shadow">
        <nav class="nav nav-underline">
            ...
            <a class="nav-link" href="Remove/">Remove Deliveries</a>
        </nav>
    </div>
    ...
    <main role="main" class="container">
        <div class="d-flex align-items-center p-3 my-3 text-white-50 hallen-bg-orange rounded box-shadow">
            ...
            <div class="lh-100">
                <h6 class="mb-0 text-white lh-100">Hallen Dashboard Home</h6>
            </div>
        </div>

        <div class="my-3 p-3 bg-white rounded box-shadow">
            <h6 class="border-bottom border-gray pb-2 mb-0">Currently Open Jobs</h6>
