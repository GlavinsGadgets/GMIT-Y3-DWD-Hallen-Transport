...
<head>
    ...
    <title>Employee Dashboard - Remove Deliveries</title>
...
<body class="bg-light">
    ...
    <div class="nav-scroller bg-white box-shadow">
        <nav class="nav nav-underline">
            ...
            <a class="nav-link active" href="../Remove/">Delete Deliveries</a>
        </nav>
    </div>
    ...
    <main role="main" class="container">
        <div class="d-flex align-items-center p-3 my-3 text-white-50 hallen-bg-orange rounded box-shadow">
            ...
            <div class="lh-100">
                <h6 class="mb-0 text-white lh-100">Hallen Dashboard Remove Deliveries</h6>
            </div>
        </div>

        <div class="my-3 p-3 bg-white rounded box-shadow">
            <h6 class="border-bottom border-gray pb-2 mb-0">Delete Deliveries from Database</h6>
            <div class="pt-3">
                <div class="container">
                            ...
                            <div class="table-responsive">
                                <?php 
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        echo "<td><a href=\"Remove.php?delete=" .$row['package_id']. "\" onclick=\"return confirm('Are you sure you want to remove " .$row['customer_name']. " from the database?');\" >Delete</a></td>";
                                        echo "</tr>";}
                                    echo "</tbody>";
